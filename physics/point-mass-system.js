...
PointMassSystem.NUM_ITERATIONS = 15;
PointMassSystem.HORIZONTAL_DAMPING = 0.035;
PointMassSystem.VERTICAL_DAMPING = 0.035;
    ...
    return {
        ...
        solve: function(dt) {
            ...
            for (i = 0; i < ilen; i++) {
                ...
                // make it rain
                pointMass.cx += (1 - PointMassSystem.HORIZONTAL_DAMPING) * (cx - px) + ax * dtSquared;
                pointMass.cy += (1 - PointMassSystem.VERTICAL_DAMPING) * (cy - py) + ay * dtSquared;
                pointMass.px = cx;
                pointMass.py = cy;
            }
